...
Usage:
    $ python path/to/train.py --data our_data.yaml --weights yolov5s.pt --img 640
"""
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/our_data.yaml', help='dataset.yaml path')
...
def run(**kwargs):
    # Usage: import train; train.run(data='our_data.yaml', imgsz=320, weights='yolov5m.pt')
    opt = parse_opt(True)
